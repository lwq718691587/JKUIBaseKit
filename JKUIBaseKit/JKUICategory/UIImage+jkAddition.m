...
@implementation UIImage (jkAddition)
...
{
    return [self imageRotatedByDegrees:RadiansToDegrees_lwq(radians)];
}
...
- (UIImage *)imageRotatedByDegrees:(CGFloat)degrees
{
    ...
    CGAffineTransform t = CGAffineTransformMakeRotation(DegreesToRadians_lwq(degrees));
    ...
    CGContextRotateCTM(bitmap, DegreesToRadians_lwq(degrees));
